...
public class RetryServiceTest {
    ...
    public void init() throws JsonProcessingException {
        ...
        TaskState taskState = new TaskState("id", "name", "assignee",
                ...
                "processDefinitionId", "processInstanceId", "ISSUE_CARD_EXCEPTION");
    ...
    @Test
    @Order(1)
    public void rertyService_200() throws Exception {
        given(onboardingRepository.save(any())).willReturn(new OnboardingTable());

        retryService.execute("Matteo");
    }

    @Test
    @Order(2)
    public void rertyService_400() throws Exception {
        given(onboardingRepository.save(any())).willReturn(new OnboardingTable());

        assertThrows(OnboardingException400.class, () -> retryService.execute("Matteo"));
